 ...
 *  Purpose: This class defines helper functions for prompting the user for input
 * 
 */
    ...
    public static String prompt(Scanner input, String promptString) {
     ...
     public static int chooseFromList(Scanner input, List<?> list) {
        ...
        do {
            ...
            String response = ScannerUtility.promptTillValid(input, "Please input your choice(Number): ", numRegex);
